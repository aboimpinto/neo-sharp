...
#pragma warning disable CS0612 // Type or member is obsolete
    public class GenesisAssets
    {
        ...
        static GenesisAssets() 
        {
            ...
            GoverningTokenRegisterTransaction.UpdateHash(BinarySerializer.Default, Crypto.Default);
            ...
            UtilityTokenRegisterTransaction.UpdateHash(BinarySerializer.Default, Crypto.Default);
